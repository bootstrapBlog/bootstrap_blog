...
function Database(databaseUser, databasePassword, databaseUrl, blogUser, blogPassword) {
  ...
  this.checkIfUserExistIfNotCreate(blogUser, blogPassword, self);
...
Database.prototype.checkIfUserExistIfNotCreate = function(name, password, self) {
  ...
  self.createUser(userData.username, userData.password);
  });
};
